...
TEST_F(SHA1HashTest, MultiValue)
{
  ...
  strings_column_wrapper const md5_string_results1({"da39a3ee5e6b4b0d3255bfef95601890afd80709",
                                                    "da39a3ee5e6b4b0d3255bfef95601890afd80709",
                                                    "da39a3ee5e6b4b0d3255bfef95601890afd80709",
                                                    "da39a3ee5e6b4b0d3255bfef95601890afd80709",
                                                    "da39a3ee5e6b4b0d3255bfef95601890afd80709"});

  strings_column_wrapper const md5_string_results2({"da39a3ee5e6b4b0d3255bfef95601890afd80709",
                                                    "da39a3ee5e6b4b0d3255bfef95601890afd80709",
                                                    "da39a3ee5e6b4b0d3255bfef95601890afd80709",
                                                    "da39a3ee5e6b4b0d3255bfef95601890afd80709",
                                                    "da39a3ee5e6b4b0d3255bfef95601890afd80709"});
  ...
  auto const string_input1      = cudf::table_view({strings_col});
  auto const string_input2      = cudf::table_view({strings_col, strings_col});
  auto const md5_string_output1 = cudf::hash(string_input1, cudf::hash_id::HASH_SHA1);
  auto const md5_string_output2 = cudf::hash(string_input2, cudf::hash_id::HASH_SHA1);
  EXPECT_EQ(string_input1.num_rows(), md5_string_output1->size());
  EXPECT_EQ(string_input2.num_rows(), md5_string_output2->size());
  expect_columns_equal(md5_string_output1->view(), md5_string_results1, true);
  expect_columns_equal(md5_string_output2->view(), md5_string_results2, true);

  auto const input1      = cudf::table_view({strings_col, ints_col, bools_col1});
  auto const input2      = cudf::table_view({strings_col, ints_col, bools_col2});
  auto const md5_output1 = cudf::hash(input1, cudf::hash_id::HASH_SHA1);
  auto const md5_output2 = cudf::hash(input2, cudf::hash_id::HASH_SHA1);
  EXPECT_EQ(input1.num_rows(), md5_output1->size());
  expect_columns_equal(md5_output1->view(), md5_output2->view(), true);
}
